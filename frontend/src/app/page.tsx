        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
          {messages.length === 0 && !loading && (
            <div className="flex flex-col items-center justify-center h-full">
              <h3 className="text-xl font-semibold text-gray-300 mb-2">Ask anything about your data</h3>
              <p className="text-sm text-gray-500 mb-8">Connect a datasource first, then start querying.</p>
